                ...
                <Box sx={{
                    ...
                    <Tabs
                        ...
                        onChange={(e, newValue) => {
                            ...
                            switch(newValue) {
                                case 0: router.push('/guia-tallas/hombre'); break;
                                case 1: router.push('/guia-tallas/mujer'); break;
                                case 2: router.push('/guia-tallas/nino'); break;
                                default: router.push('/guia-tallas/hombre');
                            }
                        }}
