...
import { Box, Typography, Button, Divider, Tooltip, Paper, CircularProgress, Badge } from '@mui/material';
...
const CartSummary = React.memo(({
    ...
    // Verificar si el usuario está autenticado - memoizado
    const isAuthenticated = useMemo(() => !!getCurrentUser(), []);
